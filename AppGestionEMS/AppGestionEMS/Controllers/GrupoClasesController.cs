...
namespace AppGestionEMS.Controllers
{
    ...
    public class GrupoClasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,nombre,descripcion")] GrupoClase grupoClase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,nombre,descripcion")] GrupoClase grupoClase)
        {
            if (ModelState.IsValid)
            {
