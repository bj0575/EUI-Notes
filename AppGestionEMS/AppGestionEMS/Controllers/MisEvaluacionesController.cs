...
namespace AppGestionEMS.Controllers
{
    ...
    public class MisEvaluacionesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var evaluaciones = db.Evaluaciones.Include(e => e.Curso).Include(e => e.Usuario).Where(p => p.UsuarioId == currentUserId);
        ...
        public ActionResult Create([Bind(Include = "Id,CursoId,UsuarioId,tipoConvocatoria,trabajo1,trabajo2,trabajo3,notaTeoria,notaPractica")] Evaluaciones evaluaciones)
        {
            ...
            ViewBag.UsuarioId = new SelectList(db.Users, "Id", "Name", evaluaciones.UsuarioId);
            return View(evaluaciones);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CursoId,UsuarioId,tipoConvocatoria,trabajo1,trabajo2,trabajo3,notaTeoria,notaPractica")] Evaluaciones evaluaciones)
        {
            if (ModelState.IsValid)
            {
